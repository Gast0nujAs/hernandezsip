...
export const Home = () => {
  return (
    <div className='flex flex-col items-center lg:pt-10 lg:pb-16 sm:pt-6 sm:pb-6 sm:mx-4 animate-fade-in animate-duration-1000'>
      <h1 className="md:text-[50px] sm:text-[35px] font-bold uppercase pb-4 font-Bebas ">Hernandez SIP</h1>
